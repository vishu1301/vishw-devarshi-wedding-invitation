...
export default function EventSection4({
  id,
  title,
  date,
  time,
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-1/4 right-10 opacity-20 hidden lg:block">
          <FlowerBloom className="w-32 h-32 text-red-400" />
        </div>
        <div className="absolute bottom-1/4 left-10 opacity-20 hidden lg:block">
          <FlowerBloom className="w-32 h-32 text-red-400" />
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              <FlowerOrnament className="w-32 h-16 mx-auto text-red-500 mb-4" />
            </motion.div>
            <h2
          ...
          <div className="relative">
            ...
            >
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 md:p-10 border border-white/50 relative">
                <div className="absolute -top-6 -left-6 transform rotate-180 opacity-70">
                  <FlowerCorner className="w-16 h-16 text-red-400" />
                </div>

                <div className="flex justify-center mb-6">
                  <RingsSvg className="w-16 h-16 text-red-500" />
                </div>
            ...
            <motion.div
              ...
              className="absolute top-1/2 -translate-y-1/2 left-0 w-64 h-64 md:w-80 md:h-80 -ml-4 md:-ml-10 hidden md:block"
            >
              <div className="relative w-full h-full overflow-hidden rounded-full shadow-xl border-4 border-white/50">
                <img
            ...
            <motion.div
              ...
              className="absolute top-1/2 -translate-y-1/2 right-0 w-64 h-64 md:w-80 md:h-80 -mr-4 md:-mr-10 hidden md:block"
            >
              <div className="relative w-full h-full overflow-hidden rounded-full shadow-xl border-4 border-white/50">
                <img
                  src={imageUrl || "/placeholder.svg"}
